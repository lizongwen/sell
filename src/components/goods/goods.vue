	...
	<div>
		<div class="goods">
			<div class="menu-wrapper" ref="menuWrapper">
				<ul>
					<li v-for="(item,index) in goods" :key="index" class="menu-item" :class="{'current':currentIndex===index}" :id="index" @click="selectMenu(index,$event)">
...
.goods .menu-wrapper .menu-item .icon.gurantee {
...
.goods .foods-wrapper .food-item:not(:last-child) {
	margin: 18px;
