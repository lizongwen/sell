...
.header .detail .detail-wrapper .detail-main .supports .support-item:not(:last-child){
	margin-bottom:12px;
}
...
.header .detail .detail-wrapper .detail-main .supports .support-item .icon.gurantee{
	background-image: url(./img/gurantee.png);
}
