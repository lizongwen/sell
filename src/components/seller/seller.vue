		...
		<div class="seller-content">
			<div class="overview">
				...
				<div class="favorite" @click="toggleFavorite">
					<span :class="{'fa fa-heart-o':!favorite,'fa fa-heart active':favorite}"></span>
...
.seller .overview .favorite .fa.active {
	color: rgb(240, 20, 20)
}
...
.seller .bulletin .supports .icon.gurantee {
