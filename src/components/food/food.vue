					...
					<div class="rating-wrapper">
						<ul v-show="food.ratings && food.ratings.length">
							<li v-show="needShow(rating.rateType,rating.text)" v-for="(rating,index) in food.ratings" :key="index" class="rating-item border-1px">
								...
								<p class="text">
									<span :class="{'fa fa-thumbs-up':rating.rateType===0,'fa fa-thumbs-o-down':rating.rateType===1}"></span>{{rating.text}}
								</p>
							</li>
						</ul>
...
.food .image-header .back .fa-angle-left {
	display: block;
	padding: 10px;
	font-size: 20px;
	color: #fff;
...
.food .rating .rating-wrapper .rating-item .text .fa-thumbs-up,
.food .rating .rating-wrapper .rating-item .text .fa-thumbs-o-down {
	margin-right: 4px;
	line-height: 16px;
	font-size: 12px;
}
